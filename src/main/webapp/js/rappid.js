...
(function(root, factory) {
    ...
    V = Vectorizer = function() {
        ...
        function e(a) {
            var b = '<svg xmlns="' + v.xmlns + '" xmlns:xlink="' + v.xlink + '" version="' + w + '">' + (a || "") + "</svg>",
                c = f(b, {
                    async: !1
                });
        ...
        function h(a, b, c) {
            var d, f;
            if (!a) return void 0;
            if ("object" == typeof a) return new m(a);
            if (b = b || {}, "svg" === a.toLowerCase()) return new m(e());
            if ("<" === a[0]) {
                var g = e(a);
        ...
        function q(a) {
            ...
            var b = parseFloat(a.attr("cx")) || 0,
                ...
                e = d * y,
                f = ["M", b, c - d, "C", b + e, c - d, b + d, c - e, b + d, c, "C", b + d, c + e, b + e, c + d, b, c + d, "C", b - e, c + d, b - d, c + e, b - d, c, "C", b - d, c - e, b - e, c - d, b, c - d, "Z"].join(" ");
            return f
        }
        ...
        function r(a) {
            ...
            var b = parseFloat(a.attr("cx")) || 0,
                ...
                f = d * y,
                g = e * y,
                i = ["M", b, c - e, "C", b + f, c - e, b + d, c - g, b + d, c, "C", b + d, c + g, b + f, c + e, b, c + e, "C", b - f, c + e, b - d, c + g, b - d, c, "C", b - d, c - g, b - f, c - e, b, c - e, "Z"].join(" ");
            return i
        }
        ...
        m.prototype = {
                    ...
                    if (s.addClass("v-line"), q)
                        if (e.annotations) {
                            for (var t = 0, u = z.annotateString(g[i], d(e.annotations) ? e.annotations : [e.annotations], {
                                ...
                                } else f = document.createTextNode(w || " ");
                                s.append(f)
                            }
                            "auto" === e.lineHeight && t && 0 !== i && s.attr("dy", 1.2 * t + "px")
                        } else s.node.textContent = q;
                    else s.addClass("v-empty-line"), s.node.style.opacity = 0, s.node.textContent = "-";
            ...
            attr: function(a, b) {
                ...
                if ("object" == typeof a)
                    for (var f in a) a.hasOwnProperty(f) && i(this.node, f, a[f]);
                else i(this.node, a, b);
                return this
            },
            remove: function() {
            ...
            append: function(a) {
                ...
                for (var c = 0, d = b.length; d > c; c++) a = b[c], this.node.appendChild(a instanceof m ? a.node : a);
                return this
            },
            prepend: function(a) {
            ...
            findIntersection: function(a, b) {
                ...
                if ("RECT" === h) {
                    var i = g.rect(parseFloat(this.attr("x") || 0), parseFloat(this.attr("y") || 0), parseFloat(this.attr("width")), parseFloat(this.attr("height"))),
                        j = this.getTransformToElement(b),
                        k = z.decomposeMatrix(j),
        ...
        return z.createSVGMatrix = function(a) {
            ...
            for (var d in b) "class" === d ? a[d] = a[d] ? a[d] + " " + b[d] : b[d] : "style" === d ? c(a[d]) && c(b[d]) ? a[d] = z.mergeAttrs(a[d], b[d]) : c(a[d]) ? a[d] = z.mergeAttrs(a[d], z.styleToObject(b[d])) : c(b[d]) ? a[d] = z.mergeAttrs(z.styleToObject(a[d]), b[d]) : a[d] = z.mergeAttrs(z.styleToObject(a[d]), z.styleToObject(b[d])) : a[d] = b[d];
            return a
    ...
    joint.mvc.View = Backbone.View.extend({
        ...
        _prepareCell: function(a) {
            var b;
            if (a instanceof Backbone.Model ? (b = a.attributes, a.graph = this) : b = a, _.isUndefined(b.z) && (b.z = this.maxZIndex() + 1), !_.isString(b.type)) throw new TypeError("dia.Graph: cell type must be a string.");
            return a
        },
        maxZIndex: function() {
        ...
        pointerup: function(a, b, c) {
            if ("label-move" === this._action) this._samples = null;
                ...
                if (!this.paper.linkAllowed(this)) switch (this._whenNotAllowed) {
                    case "remove":
                        this.model.remove();
                        break;
                    case "revert":
        ...
        return function(b, e, l, n) {
            ...
            var o = n.size || j,
                ...
                q = n.ignoreConnectors || m; - 1 === k.indexOf(p) && (p = k[0]);
            var r = this.paper,
                s = r.model,
                t = s.getLinks();
    ...
    joint.ui.SelectionView = joint.mvc.View.extend({
        ...
        init: function() {
            if (!this.options.paper) throw new Error("SelectionView: paper required");
    ...
    joint.ui.Halo = joint.mvc.View.extend({
        ...
        toggleState: function(a) {
            ...
            if (_.each(this.$pieToggles, function(a) {
                    a.removeClass("open")
                }), this.isOpen()) this.trigger("state:close", a), b.removeClass("open");
            else {
                ...
                if (!(c instanceof joint.dia.LinkView)) {
                    ...
                    if (-1 !== b.trueDirection.indexOf("right") ? m.vertical = h.x : m.vertical = f.x, -1 !== b.trueDirection.indexOf("bottom") ? m.horizontal = h.y : m.horizontal = f.y, _.find(this.options.paper.model.getElements(), function(b) {
                        ...
                        var p, q = 0,
                            ...
                            s = i % 90,
                            t = !(i % 90);
                        if (p = i >= 0 && 90 > i ? 1 : i >= 90 && 180 > i ? 4 : i >= 180 && 270 > i ? 3 : 2, t) 90 === i || 270 === i ? (q = o, r = n) : (q = n, r = o);
                        else {
                            var u = g.toRad(s);
    ...
    joint.ui.TextEditor = joint.mvc.View.extend({
            ...
            return _.each(a, function(a) {
                switch (f) {
                    ...
                    case "delete-single":
                        ...
                        break;
                    case "delete":
                        if (a.start <= b.start && b.start <= a.end) b.end <= a.end ? a.end += d : a.end += c.start - a.end;
        ...
        selectTextInElementUsingRanges: function(a, b, c) {
            ...
            for (var f, g, h, i, j, k, l = this.getTextNodesFromDomElement(a), m = 0, n = b + c; c > 0 && l.length > 0;) f = l.shift(), h = m, i = m + f.length, (h >= b && n > h || i > b && n >= i || b >= h && i > b || n > h && i >= n) && (j = Math.max(b - h, 0), k = Math.min(j + Math.min(c, f.length), i), g = document.createRange(), g.setStart(f, j), g.setEnd(f, k), d.addRange(g), c -= k - j), m += f.length
        },
    ...
    joint.ui.SelectBox = joint.mvc.View.extend({
        ...
        selectByValue: function(a, b) {
            for (var c = this.options.options || [], d = 0; d < c.length; d++) {
                ...
                if (!_.isUndefined(e.value) && e.value === a) return this.select(d, b)
            }
        },
        isOpen: function() {
    ...
    ! function() {
        ...
        if (b.width && b.height) c = b.width, d = b.height, g.left + g.right >= c && (g.left = g.right = 0), g.top + g.bottom >= d && (g.top = g.bottom = 0), f = c - g.left - g.right, e = d - g.top - g.bottom;
        else {
